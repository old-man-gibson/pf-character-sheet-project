...
export class CharacterSheetElement extends HTMLElement {
  ...
  #sheetBonusHead() { return badges.sheetBonusHead(); }

  #sheetBonusCell(key) { return badges.sheetBonusCell(this.#model, key); }

  #forwardedBadge(name, tag = '', only = '') {
    return badges.forwardedBadge(this.#model, name, tag, only);
  }

  #sheetBonusHint(examples) { return badges.sheetBonusHint(examples); }
