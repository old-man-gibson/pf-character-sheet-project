...
| [Sub-systems](docs/sub-systems.md) | The modelled sub-systems, each read once off its worksheet: Martial and Magic Spheres training, Guile Spheres, Primordia techniques (the panel, and the Technique List / AutoTechnique tabs), Akashic, Maneuvers and Vancian, Card casting, Auto-Cooking, and the three companions. |
